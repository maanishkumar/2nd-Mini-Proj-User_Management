	...
	<div class="container">
		...
		<div class="text-left">
			<br></br> <a class="btn btn-outline-success mr-sm-2"
				href="/loadSignUpForm" role="button">Sign Up</a>
		...
		<div>
			...
			<form:form class="form-signin" action="userSigIn"
				...
				<div class="row container">
					...
					<button class="btn btn-sm btn-primary btn-block col-md-2 mb-3"
						type="submit">Sign in</button>
					<br>
					<br>
				</div>
				<a class="btn btn-sm btn-dark  btn-block col-md-2 mb-3 "
					href="/loadforgotPwdForm" role="button">Forgot Password</a>
